...
async function run() {
  ...
  const casesRaw = [
    { id:1,  type:"medical",      cityIdx:1, target:12000, raised:5200,  ar:"احتياج طارئ لعملية قلب مفتوح",            en:"Urgent Need for Open Heart Surgery",          dAr:"طفل يحتاج إلى عملية قلب مفتوح عاجلة ولا تتوفر تكاليف العملية.",               dEn:"A child needs urgent open heart surgery but cannot afford the costs." },
    { id:2,  type:"medical",      cityIdx:0, target:5000,  raised:1800,  ar:"علاج ابني من مرض السكري",                 en:"Treating My Son's Diabetes",                  dAr:"أحتاج لمساعدة في تأمين أنسولين ومستلزمات السكري لابني المريض.",              dEn:"I need help securing insulin and diabetes supplies for my sick son." },
    { id:3,  type:"education",    cityIdx:2, target:8000,  raised:3400,  ar:"مساعدة لإتمام الدراسة الجامعية",          en:"Help to Complete University Studies",          dAr:"طالبة متفوقة تحتاج مساعدة مالية لإتمام دراستها الجامعية.",                   dEn:"An outstanding student needs financial help to complete her university studies." },
    { id:4,  type:"relief",       cityIdx:7, target:3000,  raised:1200,  ar:"أسرة نازحة تحتاج مأوى",                   en:"Displaced Family Needs Shelter",              dAr:"أسرة من خمسة أفراد نزحت وتحتاج تأمين سكن مؤقت ومستلزمات أساسية.",           dEn:"A family of five displaced and needs temporary shelter and basic supplies." },
    { id:5,  type:"medical",      cityIdx:3, target:15000, raised:9800,  ar:"دعم مريضة بسرطان الثدي",                  en:"Support a Breast Cancer Patient",             dAr:"امرأة تحارب سرطان الثدي وتحتاج لتمويل جلسات العلاج الكيميائي.",              dEn:"A woman battling breast cancer needs funding for chemotherapy sessions." },
    { id:6,  type:"housing",      cityIdx:4, target:7000,  raised:2100,  ar:"ترميم منزل متضرر من الزلزال",             en:"Repairing Earthquake-Damaged Home",           dAr:"منزل تضرر جزئياً من الزلزال ويحتاج لأعمال ترميم عاجلة.",                    dEn:"A home partially damaged by the earthquake needs urgent restoration work." },
    { id:7,  type:"education",    cityIdx:5, target:10000, raised:4200,  ar:"مدرسة خاصة للأطفال ذوي الاحتياجات",      en:"Special School for Children with Disabilities",dAr:"مبادرة لإنشاء فصل دراسي خاص للأطفال ذوي الاحتياجات الخاصة.",               dEn:"An initiative to create a special classroom for children with special needs." },
    { id:8,  type:"medical",      cityIdx:6, target:9000,  raised:2500,  ar:"كلفة عملية جراحية عاجلة في العمود الفقري",en:"Cost of Urgent Spinal Surgery",              dAr:"شاب يحتاج لعملية جراحية عاجلة في العمود الفقري ولا يملك التكاليف.",         dEn:"A young man needs urgent spinal surgery but cannot afford the costs." },
    { id:9,  type:"relief",       cityIdx:8, target:2400,  raised:800,   ar:"غذاء لأسرة كبيرة في ضائقة",              en:"Food for Large Family in Hardship",           dAr:"أسرة من عشرة أفراد تعاني من شح الغذاء وتحتاج للدعم الشهري.",               dEn:"A family of ten suffering from food scarcity and needs monthly support." },
    { id:10, type:"medical",      cityIdx:9, target:25000, raised:11000, ar:"علاج طفل من مرض نادر",                    en:"Treating a Child with a Rare Disease",        dAr:"طفل مصاب بمرض نادر يحتاج علاجاً مكلفاً غير متوفر في سوريا.",               dEn:"A child with a rare disease needs expensive treatment not available in Syria." },
    // Submitted (5)
    { id:11, type:"housing",      cityIdx:0, target:4800,  raised:0,     ar:"إيجار منزل للعائلة النازحة",              en:"House Rental for Displaced Family",           dAr:"أسرة نازحة تحتاج لمساعدة في دفع إيجار المنزل لمدة سنة.",                   dEn:"A displaced family needs help paying house rent for one year." },
    { id:12, type:"education",    cityIdx:1, target:3600,  raised:0,     ar:"رسوم مدرسية للأطفال الخمسة",             en:"School Fees for Five Children",               dAr:"أم أرملة تحتاج مساعدة في تسديد رسوم مدرسة أطفالها الخمسة.",                dEn:"A widowed mother needs help paying school fees for her five children." },
    { id:13, type:"medical",      cityIdx:2, target:6000,  raised:0,     ar:"علاج الأسنان للمحتاجين",                  en:"Dental Treatment for Needy",                  dAr:"حملة لتوفير علاج الأسنان المجاني للأشخاص المحتاجين.",                       dEn:"A campaign to provide free dental treatment for needy people." },
    { id:14, type:"relief",       cityIdx:3, target:2000,  raised:0,     ar:"حطب للتدفئة في الشتاء",                  en:"Firewood for Winter Heating",                 dAr:"عائلات تحتاج حطباً ووقوداً للتدفئة في فصل الشتاء البارد.",                 dEn:"Families need firewood and fuel to stay warm in the cold winter season." },
    { id:15, type:"housing",      cityIdx:4, target:5500,  raised:0,     ar:"مساعدة لأسرة بلا مأوى",                  en:"Help for a Homeless Family",                  dAr:"أسرة فقدت منزلها في الحريق وتحتاج إلى إيجاد مسكن بديل.",                   dEn:"A family lost their home in a fire and needs to find alternative housing." },
    // Under review (3)
    { id:16, type:"medical",      cityIdx:5, target:3600,  raised:0,     ar:"أدوية مزمنة لمريض كبير السن",            en:"Chronic Medications for Elderly Patient",     dAr:"مريض كبير في السن يحتاج لأدوية مزمنة شهرية لا يستطيع توفيرها.",           dEn:"An elderly patient needs monthly chronic medications they cannot afford." },
    { id:17, type:"education",    cityIdx:6, target:14000, raised:0,     ar:"تأهيل مهني للشباب العاطل عن العمل",      en:"Vocational Training for Unemployed Youth",    dAr:"برنامج لتدريب الشباب العاطل عن العمل على مهن تمكنهم من كسب الرزق.",        dEn:"A program to train unemployed youth in skills that help them earn a living." },
    { id:18, type:"relief",       cityIdx:7, target:8000,  raised:0,     ar:"صناديق الإغاثة الطارئة",                 en:"Emergency Relief Boxes",                      dAr:"توزيع صناديق الإغاثة بالاحتياجات الأساسية للأسر المنكوبة.",                dEn:"Distributing emergency relief boxes with basic necessities to affected families." },
    // Approved (2)
    { id:19, type:"medical",      cityIdx:8, target:6500,  raised:1500,  ar:"عملية قسطرة قلبية",                       en:"Cardiac Catheterization Procedure",           dAr:"مريض يحتاج لإجراء قسطرة قلبية وتكاليف العملية خارج إمكانياته.",           dEn:"A patient needs a cardiac catheterization procedure beyond their means." },
    { id:20, type:"education",    cityIdx:9, target:1200,  raised:400,   ar:"كمبيوتر محمول للطالب المتفوق",            en:"Laptop for Outstanding Student",              dAr:"طالب في الهندسة بحاجة لحاسوب محمول لمواصلة دراسته وأبحاثه.",              dEn:"An engineering student needs a laptop to continue his studies and research." },
  ]
  ...
  const productsRaw = [
    ...
    { partnerId:2, title:"زيت زيتون سوري بكر",       price:22,  cost:14, stock:90  },
